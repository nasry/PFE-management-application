                 ...
                 <div class="span12">
                     ...
                     <div class="widget widget-tabs blue">
                          <div class="widget-title">
                            <h4><i class="icon-reorder"></i> Specialités </h4>
                            <span class="tools">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="nav-collapse collapse navbar-responsive-collapse">
                                                ...
                                                <ul class="nav pull-right">
                                                    <li>
                                                      <a href="#" data-reveal-id="myModal_2" data-animation="fade">
                                                        Ajouter une spécialité <i class="icon-plus"></i>
                                                      </a>
                                                    </li>
                                                </ul>
                                            </div>
                             ...
                             <div>
                              <div class="clearfix">
                                 <div id="myModal_2" class="reveal-modal">  
                                   <?php include("ajouter_specialite.php") ;  ?>
                                 </div>  
                              </div>
                                 ...
                                 <table class="table table-striped table-hover table-bordered" id="editable-sample_2">
                                     ...
                                     <tbody>
                                       <tr class="">
                                          ...
                                          <td>Informatique</td>
                                          <td>
                                            <a href="#" data-reveal-id="myModal_22" data-animation="fade">
                                 ...
                                 <div class="clearfix">
                                  <div id="myModal_22" class="reveal-modal">  
                                   <?php include("modifier_specialite.php") ;  ?>
                                  </div>  
                              </div>
                             </div>
                         </div>
