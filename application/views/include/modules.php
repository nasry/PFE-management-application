                                        ...
                                        <div class="container">
                                            ...
                                            <div class="nav-collapse collapse navbar-responsive-collapse">
                                                ...
                                                <ul class="nav pull-right">
                                                    <li>
                                                      <a href="#" data-reveal-id="myModal_4" data-animation="fade">
                                                        Ajouter un module <i class="icon-plus"></i>
                                                      </a>
                                                    </li>
                                                </ul>
                                            </div>
                             ...
                             <div>
                              <div class="clearfix">
                                 <div id="myModal_4" class="reveal-modal">  
                                   <?php include("ajouter_module.php") ;  ?>
                                 </div>  
                              </div>
                                 ...
                                 <table class="table table-striped table-hover table-bordered" id="editable-sample_4">
                                     ...
                                     <tbody>
                                       <tr class="">
                                          ...
                                          <td>Informatique</td>
                                          <td>
                                            <a href="#" data-reveal-id="myModal_44" data-animation="fade">
                                 ...
                                 <div class="clearfix">
                                  <div id="myModal_44" class="reveal-modal">  
                                   <?php include("modifier_module.php") ;  ?>
                                  </div>  
                              </div>
                             </div>
                         </div>
