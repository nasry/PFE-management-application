                                        ...
                                        <div class="container">
                                            ...
                                            <div class="nav-collapse collapse navbar-responsive-collapse">
                                                ...
                                                <ul class="nav pull-right">
                                                    <li>
                                                      <a href="#" data-reveal-id="myModal_3" data-animation="fade">
                                                        Ajouter un niveau <i class="icon-plus"></i>
                                                      </a>
                                                    </li>
                                                </ul>
                                            </div>
                             ...
                             <div>
                              <div class="clearfix">
                                 <div id="myModal_3" class="reveal-modal">  
                                   <?php include("ajouter_niveau.php") ;  ?>
                                 </div>  
                              </div>
                                 ...
                                 <table class="table table-striped table-hover table-bordered" id="editable-sample_3">
                                     ...
                                     <tbody>
                                       <tr class="">
                                          ...
                                          <td>Informatique</td>
                                          <td>
                                            <a href="#" data-reveal-id="myModal_33" data-animation="fade">
                                 ...
                                 <div class="clearfix">
                                  <div id="myModal_33" class="reveal-modal">  
