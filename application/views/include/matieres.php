                 ...
                 <div class="span12">
                     ...
                     <div class="widget widget-tabs blue">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="nav-collapse collapse navbar-responsive-collapse">
                                                ...
                                                <ul class="nav pull-right">
                                                    <li>
                                                      <a href="#" data-reveal-id="myModal_5" data-animation="fade">
                                                        Ajouter une matière <i class="icon-plus"></i>
                                                      </a>
                                                    </li>
                                                </ul>
                                            </div>
                         ...
                         <div class="widget-body" >
                             <div>
                              <div class="clearfix">
                                 <div id="myModal_5" class="reveal-modal">  
                                   <?php include("ajouter_matiere.php") ;  ?>
                                 </div>  
                              </div>
                                 ...
                                 <table class="table table-striped table-hover table-bordered" id="editable-sample_5">
                                     ...
                                     <tbody>
                                       <tr class="">
                                          ...
                                          <td>Informatique</td>
                                          <td>
                                            <a href="#" data-reveal-id="myModal_55" data-animation="fade">
                                 ...
                                 <div class="clearfix">
                                  <div id="myModal_55" class="reveal-modal">  
                                   <?php include("modifier_matiere.php") ;  ?>
                                  </div>  
                              </div>
                             </div>
                         </div>
