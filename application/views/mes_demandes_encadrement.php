...
<head>
   <meta charset="utf-8" />
   <title>Mes demandes d'encadrement </title>
                 ...
                 <div class="span12">
                     ...
                     <div class="widget widget-tabs blue">
                          <div class="widget-title">
                            <h4><i class="icon-reorder"></i> Mes demandes d'encadrement </h4>
                            <span class="tools">
                                 ...
                                 <?php if( !empty($results))
                                {
                                 ?>
                                     <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                         ...
                                         <tbody>
                                     <?php
                                      echo form_open("mesDemandesEnc/accepterEtudiant");
                                     ...
                                     ?>
                                           <tr class="">
                                              ...
                                              <td>
                                                 <input type="checkbox" name="etudiantAccepter[]" value="<?php echo $row->numero_inscri  ?>" />
                                              </td>
                                          </tr>
                                      <?php
                                      }
                                  ...
                                  <div class="space20"></div>
                                            <center><button class="btn  btn-primary" type="submit">Accepter</button></center>
                                        </div>
                                 <?php
                                  }
                                  else
                                 ...
                                 ?>
                                  <div class="alert alert-block alert-success fade in">
                                                <p>
                                                  <h5>Vous n'avez pas encore des nouvelles demandes d'encadrement</h5>
                                                </p>
                                              </div>
                                 <?php }?>
                                 <div class="clearfix">
